            ...
            <div key={index} className="bg-bg-secondary rounded-apple p-md border border-bg-tertiary">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <div className="text-xs text-text-secondary">{domain.dailyLimit}/day</div>
                </div>
                <button
        ...
        <div className="bg-bg-secondary rounded-apple p-md border border-bg-tertiary">
          <div className="flex items-center gap-sm">
            ...
            <input
              ...
              min="1"
              max="10"
              className="w-16 bg-bg-tertiary text-text-primary px-sm py-xs rounded border-none text-sm"
            />
                          <AppleWatchButton
                variant="primary"
                size="small"
